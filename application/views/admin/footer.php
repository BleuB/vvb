	...
	$(document).on('lity:open', function(event, instance) {
   		...
   		$.ajax({
            ...
            success : function(data){
             	...
             	$('#inputTel').attr('value',data[0].phone);
             	$('#inputPortable').attr('value',data[0].mobile);
             	$('#inputFax').attr('value',data[0].fax);
             	$('#inputMail').attr('value',data[0].email);
             	$('#inputWeb').attr('value',data[0].url);
            },
		});
	});
</script>
