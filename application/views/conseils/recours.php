		...
		<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
			...
			<div class="row">
				<div class="col-xs-12 col-md-6 text-justify vertical-align-item">
					...
					<p><i class="fa fa-square" aria-hidden="true"></i> Vous avez loué par l’intermédiaire d’une agence de voyages. Vous pouvez porter votre plainte devant le syndicat national des agents de voyage : (SNAV, 15 Avenue Carnot, 75017 Paris )</p>
