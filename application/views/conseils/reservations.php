	...
	<div class="row">
		<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
		 ...
		 --><div class="col-xs-12 col-md-6 text-justify vertical-align-item">
					...
					<p><i class="fa fa-square" aria-hidden="true"></i> Avant de vous remettre les clefs, le loueur peut vous demander de verser une caution afin de le garantir des éventuelles dégradations ou mauvais entretien dont vous pourriez être tenu responsable. Son montant est fixé librement. Vous devez lors de son versement demander un reçu et l’indication par écrit des conditions de sa restitution si cela n’est pas déjà indiqué au contrat.</p>
					<strong>Une fois sur place, est-il nécessaire de rédiger un état des lieux ?</strong>
